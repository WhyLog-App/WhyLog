...
public class TeamController {
    ...
    public ApiResponse<TeamResponse.InvitationResponseDTO> sendInvitation(
            @PathVariable Long teamId, @Valid @RequestBody TeamRequest.InvitationDTO request) {
    ...
    public ApiResponse<TeamResponse.TeamCreateResponseDTO> createTeam(
            ...
            @Parameter(hidden = true) @Valid @RequestPart("request")
                    TeamRequest.TeamCreateDTO request,
            @Parameter(hidden = true) @RequestPart(value = "image", required = false)
                    MultipartFile image) {
    ...
    public ApiResponse<TeamResponse.TeamRemoveResponseDTO> removeTeam(
            @CurrentMember Long memberId, @PathVariable Long teamId) {
